/*============================================================================*/
#include "../../../../include/ShishGL/GUI/UIWindow/Shapes/CircleShape.hpp"
...
void CircleShape::setOverallDimension(const Vector2<double>& new_size) {
    radius = std::min(new_size.x, new_size.y) / 2.;
}
